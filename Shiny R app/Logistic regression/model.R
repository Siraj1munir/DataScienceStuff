...
## Function to implement variable selection in the logistic regression.
...
## Function to perform modeling using a logistic regression.
...
## Function to take an existing logistic regression model and create predictions in new data.
...
## Function to take an existing logistic regression model and produce an ROC curve using new data.
## Use if test data is not dummied.
